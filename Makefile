...
build:
	...
	@uglifyjs --no-copyright docs/assets/js/bootstrap.js > docs/assets/js/bootstrap.min.tmp.js
...
bootstrap:
	...
	uglifyjs --no-copyright bootstrap/js/bootstrap.js > bootstrap/js/bootstrap.min.tmp.js
